...
public class ApiHandler {
    ...
    public String sendGet(String url, Map<String,String> headers) {
        ...
        try {
            ...
            con.setRequestProperty("Access-Control-Expose-Headers", "content-range, Content-Type, Access-Control-Allow-Headers, X-Authorization, Authorization, X-Requested-With");
            con.setRequestProperty("Access-Control-Allow-Headers", "content-range, Content-Type, Access-Control-Allow-Headers, X-Authorization, Authorization, X-Requested-With");
